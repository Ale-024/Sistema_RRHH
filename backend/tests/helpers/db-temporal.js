...
async function crearBaseTemporal() {
  ...
  execSync(
    ...
    { cwd: path.join(__dirname, '..', '..'), env, stdio: 'pipe' }
  );
  ...
  const MATRIZ = {
    ...
    RRHH_SUP: [
      ...
      'solicitudes:revisar', 'solicitudes:leer_global', 'planilla:leer_global',
    ],
    GERENTE_DEPTO: ['empleados:leer', 'asistencia:leer_global', 'solicitudes:revisar'],
